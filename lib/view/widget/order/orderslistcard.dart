        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(
              ...
              value:
                  "${Jiffy.parse(listdata.ordersDatetime!).add(hours: 3).fromNow()}",
            ),
            ...
            Text(
              translateDatabase(
                ...
                "Total: ${listdata.ordersPrice?.toStringAsFixed(2)} RYE",
              ),
              style: const TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.bold,
            ...
            Wrap(
              ...
              children: [
                ...
                //   ),
                if (listdata.ordersStatus == 3 &&
                    listdata.ordersImagePayStatus != 2 &&
                    listdata.ordersPaymentmethod!.toString() == "1")
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                ...
                if (listdata.ordersStatus == 3 &&
                    listdata.ordersImagePayStatus == 1 &&
                    listdata.ordersPaymentmethod!.toString() == "1")
                  ElevatedButton(
                    onPressed: () {},
